...
public class DynamicListView extends ListView {
    ...
    private String TAG = DynamicListView.class.getSimpleName();
    private final int SMOOTH_SCROLL_AMOUNT_AT_EDGE = 100;
    private final int MOVE_DURATION = 150;
    private final int LINE_THICKNESS = 15;
    private final int HOVER_ALPHA = 150;
    ...
    private int mTargetDownY = -1;
    private int mTargetDownX = -1;
    ...
    private DynamicListViewListener dynamicListViewListener;
    ...
    public void setDynamicListViewListener(DynamicListViewListener dynamicListViewListener){
        this.dynamicListViewListener = dynamicListViewListener;
    }
    ...
    private BitmapDrawable getAndAddHoverView(View v) {
        ...
        drawable.setAlpha(HOVER_ALPHA);

        Log.e(TAG, "getAndAddHoverView");
    ...
    private void updateNeighborViewsForID(long itemID) {
        ...
        selectedItemIndex = position != INVALID_ID ? position : selectedItemIndex;
        TimeLineAdapter adapter = ((TimeLineAdapter) getAdapter());
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (event.getAction() & MotionEvent.ACTION_MASK) {
            ...
            case MotionEvent.ACTION_MOVE:
                isDragStarted = true;
                mTargetDownX = (int) event.getX();
                mTargetDownY = (int) event.getY();
            ...
            case MotionEvent.ACTION_UP:
                if(isDragStarted) {
                    int position = pointToPosition(mTargetDownX, mTargetDownY);
                    int itemNum = position - getFirstVisiblePosition();
                    int targetIndex = getFirstVisiblePosition() + itemNum;
                    dynamicListViewListener.onRowSwap(selectedItemIndex, targetIndex);
                    isDragStarted = false;
                }
                touchEventsEnded();
                break;
    ...
    private void handleCellSwitch() {
        ...
        if (isBelow || isAbove) {
            ...
            // Log.e(TAG, "originalItem: " + originalItem);
            ...
            swapElements(timeLineArrayList, originalItem, getPositionForView(switchView));
    ...
    public void setCheeseList(ArrayList<TimeLine> timeLineArrayList) {
    ...
    public interface DynamicListViewListener{
        void onRowSwap(int fromPosition, int toPosition);
    }
}